...
REPLACE INTO `item_db_re` VALUES (2011,'Golden_Rod_Staff2','Golden Rod Staff II',4,20,NULL,900,'30:270',NULL,1,1,0x00000200,7,2,34,4,130,1,10,'bonus bAtkEle,Ele_Wind; bonus bInt,5; bonus2 bSkillAtk,\"WZ_JUPITEL\",30; if (isequipped(2467,2859,15025)) { bonus2 bSubEle,Ele_Earth,-50; };',NULL,NULL);
...
REPLACE INTO `item_db_re` VALUES (1566,'Diary_Of_Great_Basil','Diary Of Great Basil',4,20,NULL,0,'120:125',NULL,1,0,0x00410100,7,2,2,1,0,0,15,'bonus2 bAddRace,RC_Boss,50; bonus2 bAddRace,RC_NonBoss,50;',NULL,NULL);
